...
for passo in (passo / 1000 for passo in range(5, 51, 5)):
    ...
    masc_gauss_1 = filtros_projeto.fazerMascaraGaussiana2D(M, N, 0.05)
    masc_gauss_2 = filtros_projeto.fazerMascaraGaussiana2D(M, N, 0.1)
    masc_gauss_3 = filtros_projeto.fazerMascaraGaussiana2D(M, N, 0.15)

    filt1 = img * masc_gauss_1
    filtragem1 = abs(np.fft.ifft2(filt1))

    filt2 = img * masc_gauss_2
    filtragem2 = abs(np.fft.ifft2(filt2))

    filt3 = img * masc_gauss_3
    filtragem3 = abs(np.fft.ifft2(filt3))

    plt.figure()
    plt.title('Imagem filtro Gaussiano fc=0.05 para ruído de var = ' + str(passo))
    plt.imshow(filtragem1, cmap='gray')

    plt.figure()
    plt.title('Imagem filtro Gaussiano fc=0.1 para ruído de var = ' + str(passo))
    plt.imshow(filtragem2, cmap='gray')

    plt.figure()
    plt.title('Imagem filtro Gaussiano fc=0.15 para ruído de var = ' + str(passo))
    ...
    print('O eqmn da imagem com filtro Gaussiano fc=0.05 é de: ' + str(eqmn_m1))
    print('O emax da imagem com filtro Gaussiano fc=0.05 é de: ' + str(emax_m1))
    print('O fator de qualidade da imagem filtro Gaussiano fc=0.05 é de: ' + str(Q_m1))
    ...
    print('O eqmn da imagem com filtro Gaussiano fc=0.1 é de: ' + str(eqmn_m2))
    print('O emax da imagem com filtro Gaussiano fc=0.1 é de: ' + str(emax_m2))
    print('O fator de qualidade da imagem filtro Gaussiano fc=0.1 é de: ' + str(Q_m2))
    ...
    print('O eqmn da imagem com filtro Gaussiano fc=0.15 é de: ' + str(eqmn_m3))
    print('O emax da imagem com filtro Gaussiano fc=0.15 é de: ' + str(emax_m3))
    print('O fator de qualidade da imagem filtro Gaussiano fc=0.15 é de: ' + str(Q_m3))
    print(' ')
    print(' ')
...
# Médias filtro Gaussiano fc=0.05
print('A média de eqmn filtro Gaussiano fc=0.05 é de: ' + str(media_eqmn_m1))
print('A média de emax filtro Gaussiano fc=0.05 é de: ' + str(media_emax_m1))
print('A média de Q filtro Gaussiano fc=0.05 é de: ' + str(media_Q_m1))
# Desvio filtro Gaussiano fc=0.05
print('O desvio padrão de eqmn filtro Gaussiano fc=0.05 é de: ' + str(dp_eqmn_m1))
print('O desvio padrão de emax filtro Gaussiano fc=0.05 é de: ' + str(dp_emax_m1))
print('O desvio padrão de Q filtro Gaussiano fc=0.05 é de: ' + str(dp_Q_m1))
print('')

# Médias filtro Gaussiano fc=0.1
print('A média de eqmn filtro Gaussiano fc=0.1 é de: ' + str(media_eqmn_m2))
print('A média de emax filtro Gaussiano fc=0.1 é de: ' + str(media_emax_m2))
print('A média de Q filtro Gaussiano fc=0.1 é de: ' + str(media_Q_m2))
# Desvio filtro Gaussiano fc=0.1
print('O desvio padrão de eqmn filtro Gaussiano fc=0.1 é de: ' + str(dp_eqmn_m2))
print('O desvio padrão de emax filtro Gaussiano fc=0.1 é de: ' + str(dp_emax_m2))
print('O desvio padrão de Q filtro Gaussiano fc=0.1 é de: ' + str(dp_Q_m2))
print('')

# Médias filtro Gaussiano fc=0.15
print('A média de eqmn filtro Gaussiano fc=0.15 é de: ' + str(media_eqmn_m3))
print('A média de emax filtro Gaussiano fc=0.15 é de: ' + str(media_emax_m3))
print('A média de Q filtro Gaussiano fc=0.15 é de: ' + str(media_Q_m3))
# Desvio filtro Gaussiano fc=0.15
print('O desvio padrão de eqmn filtro Gaussiano fc=0.15 é de: ' + str(dp_eqmn_m3))
print('O desvio padrão de emax filtro Gaussiano fc=0.15 é de: ' + str(dp_emax_m3))
print('O desvio padrão de Q filtro Gaussiano fc=0.15 é de: ' + str(dp_Q_m3))
